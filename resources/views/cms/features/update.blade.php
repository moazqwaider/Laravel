                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Update Recourd In Features Section</h3>
                        </div>
                        <!-- /.card-header -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @php
                                                $title_en = $feature->getTranslation('title', 'en')
                                            @endphp
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title_ar"
                                                value="{{ $feature->getTranslation('title', 'ar') }}" name="title_ar" placeholder="Title Ar ..">
                                        </div>
                                    </div>
                                </div>

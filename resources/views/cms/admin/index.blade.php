                        ...
                        <table class="table table-hover table-bordered table table-striped text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <td><img class="img-circle img-bordered-sm" src="{{asset(Storage::url('images/'.$admin->image))}} " width="80" height="70" alt="User Image"></td> --}}
                                    ...
                                    <td><span
                                            class="badge @if ($admin->active == true)  bg-success
                                        @else
                                            bg-danger @endif">{{$admin->active ? 'Active':'Disabled'}}</span>
                                    </td>
                                    <td>{{ $admin->created_at }}</td>
                                    <td><span class="tag tag-success">{{ $admin->updated_at }}</span></td>
                                    <td>
                                        <div class="btn-group d-flex justify-content-center">
                                            ...
                                            <a href="#" onclick="confiramDestroy({{ $admin->id }},this)"
...
@section('js')
    ...
    {{-- <script>
        function search() {
            ...
            axios.post('/cms/admin/admin/search/', {

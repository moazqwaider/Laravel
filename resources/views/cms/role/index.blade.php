                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($roles as $role)
                                            <tr>
                                                ...
                                                {{-- <td><img class="img-circle img-bordered-sm" src="{{asset(Storage::url('images/'.$role->image))}} " width="80" height="70" alt="User Image"></td> --}}

                                                <td>{{ $i++ }}</td>
                                                <td>{{ $role->name }}</td>
                                                <td><span class="badge bg-success">{{ $role->guard_name }}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td><span class="tag tag-success">{{ $role->updated_at }}</span></td>
                                                <td>
                                                    <div class="btn-group d-flex justify-content-center">
                                                        ...
                                                        <a href="#"
                                                            onclick="confiramDestroy({{ $role->id }},this)"
...
@section('js')
    ...
    {{-- <script>
        function search() {
            ...
            axios.post('/cms/role/role/search/', {

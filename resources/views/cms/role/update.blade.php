...
@section('title', 'Role')
@section('main-title', 'Update Role')
                        ...
                        <form id="create-form">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="{{$role->name}}" placeholder="Role Name..">
                                </div>
                            </div>
                            <!-- /.card-body -->

                            <div class="card-footer">
                                <button type="button" class="btn btn-primary" onclick="updateRole({{$role->id}})">Update</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->

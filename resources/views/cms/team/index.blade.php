                    ...
                    <form">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Teams-Section Table</h3>
                        ...
                        <table class="table table-hover table-bordered table table-striped text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$i++}}</td>
                                    <td><img src="{{asset(Storage::url('images/'.$team->image))}} " width="100px" height="120px" alt="User Image"></td>

                                    <td>{{ $team->name }}</td>
                                    <td>{{ $team->description}}</td>

                                    <td>{{ $team->created_at }}</td>
                                    <td><span class="tag tag-success">{{ $team->updated_at }}</span></td>
                                    <td>
                                        <div class="btn-group d-flex justify-content-center">
                                            ...
                                            <a href="#" onclick="confiramDestroy({{ $team->id }},this)"
...
@section('js')
    ...
    {{-- <script>
        function search() {
            ...
            axios.post('/cms/team/team/search/', {
